			...
			<div>
				...
				<table border="0" width="100%">
					<tr>
						...
						<td>
							<div>
								<div><label>Event/Note Subject:</label><input type="text" name="note" class="dsusa_input" id="note" style="width:253px;"></div><br/>
								<div style="float:left;"><label>Start Date:</label><br/>
								<img src="<?=base_url()?>assets/images/date_add.png" class="data_ico" />
								<input class="d_field dsusa_input" type="text" id="start_date" name="start_date" /></div>
								<div style="float:left;padding-left:5px;"><label>End Date:</label><br/>
								<img src="<?=base_url()?>assets/images/date_add.png" class="data_ico" />
								<input class="d_field dsusa_input" type="text" id="end_date" name="end_date"  /></div>
							</div><br/><br/>
