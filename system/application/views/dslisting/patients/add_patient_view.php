...
<script type="text/javascript">
	...
	$(function(){
		...
		$('.wysiwyg_text').wysiwyg('clear');
		
		$('input:[name=save_id]').val(0);
		$('input:[name=pdf_file]').val(0);
		...
		$('input:[name=appointment_made]').removeAttr('checked');
	})
		...
		<form id="personal_info" action="#">
			<div id="personal_info_col_left" style="display:inline;float:left;width: 360px; border-right: 1px solid #eeeeee;">
				...
				<div class="row">
					...
					<input type="hidden" name="pdf_file" value="0"/>
					<label>Caller Name:</label><br/>
					<input id="caller_name_field" class="medium_input_text txt capitalize_for_names" type="text" name="caller_name" />
				</div><!-- /row end -->
				<div class="row">
				...
				<div class="row">
					...
					<input class="medium_input_text txt" type="text" name="phone" />
				</div><!-- /row end -->
				<div class="row">
				...
				<div class="row">
					...
					<input class="medium_input_text txt capitalize_for_names" type="text" id="patient_name_field" name="patient_name" />
				</div><!-- /row end -->
				<div class="row">
					<div id="dentist_info_container">
						<label id="label_dentist_assigned_to">Dentist Assigned to: <input onchange="assign_no_dentist(this)" style="margin-top: 0px;" id="none_checkbox" type="checkbox"><i style="color:#00796b;">None</i></label><br/>
						<input id="input_dentist_assigned_to" onfocus="open_search(this)" readonly="readonly" class="medium_input_text txt input_dentist_field" type="text" />
				...
				<div class="row">
					...
					<input id="last_app_date" class="small_input_text txt input_date_field" type="text" name="last_appointment_date" />
				</div><!-- /row end -->
				<div class="row">
					<label>Date of Birth:</label><br/>
					<input id="birth_date" class="small_input_text txt input_date_field" type="text" name="birth_day" />
				</div><!-- /row end -->
				<div class="row">
					<label>Address:</label><br/>
					<input class="semi_wide_input_text txt" type="text" name="address" />
				</div><!-- /row end -->
				<div class="row">
					<label>City:</label><br/>
					<input class="semi_wide_input_text txt city_zip_autocomplete {autoc_width:335,autoc_type:'city_name'}" type="text" name="city" />
				</div><!-- /row end -->
				<div class="row">
					<label>State:</label><br/>
					<input class="semi_wide_input_text txt city_zip_autocomplete {autoc_width:335,autoc_type:'state'}" type="text" name="state" />
				</div><!-- /row end -->
				<div class="row">
					<label>Zip:</label><br/>
					<input class="medium_input_text txt city_zip_autocomplete {autoc_width:194,autoc_type:'zip'}" type="text" name="zip" />
				</div><!-- /row end -->
				<div class="row">
					<label>Email Address:</label><br/>
					<input class="medium_input_text txt" type="text" name="email" />
				</div><!-- /row end -->
				<div class="row">
					<label>Office Contact:</label><br/>
					<input class="medium_input_text txt" type="text" name="office_contact" />
				</div><!-- /row end -->
				<div class="row saved_readonly" id="appoinment_made_box">
					<input type="checkbox" onchange="appointment_clear(this)" name="appointment_made"> <label style="font-weight:bold;">Appointment Made</label><br/><br/>
					<div class="appointment_field_containers">
						<label>Appointment Date:</label><br/>
						<input id="app_date" onchange="check_appointment()" class="small_input_text txt input_date_field" type="text" name="appointment_date" /><br/>
					</div>
					<div class="appointment_field_containers">
						<label>Appointment time:</label><br/>
						<input id="app_time" onchange="check_appointment()" class="small_input_text" type="text" name="appointment_time" readonly="readonly" />
					</div>
			...
			<div id="personal_info_col_right" style="display:inline;float:left; padding-left: 20px;height: auto;">
				<div id="notes_add_patient">
					<h4>Notes:</h4>
					<div class="row">
						<textarea rows="38" cols="63" class="wysiwyg_text" name="notes"></textarea>
					</div><!-- /row end --><br>
				</div>
				<div id="notes_edit_patient">
					<h4>Notes:</h4>
					<div class="row" id="saved_notes_edit" style="width: 530px;">
						<div class="row" id="saved_notes_edit_text"></div>
