...
<link rel="stylesheet" type="text/css" href="<?=min_file('assets/themes/default/css/all.css')?>" />
<style type="text/css">
	#jsddm li a{
		font-size: 12px;
	}
...
<script type="text/javascript" src="<?=min_file('assets/js/main.js')?>"></script>
<script type="text/javascript" src="<?=min_file('assets/js/jquery-ui-timepicker.js')?>"></script>
