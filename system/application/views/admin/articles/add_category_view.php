...
<script type="text/javascript">
	...
	$(function(){
		$('input#btn_save').click(function(){
			process_form('input#btn_save','SAVE','div#category_form_messages',true,'form#category_form','_admin_console/articles/save_category',false,'save_success');
		});
	})
</script>
<div>
	...
	<form id="category_form">
		Category Title<br/>	
		<input type="text" class="wide_input_text" name="category_title" /><br/><br/>
		Description<br/>
