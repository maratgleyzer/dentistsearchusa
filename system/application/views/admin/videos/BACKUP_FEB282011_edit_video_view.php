...
<div>
	...
	<form id="video_form">
		Preview Image<br>
		<input type="hidden" value="<?=$image?>" id="prev_image" name="image"/>
		...
		<br/><br/>
		Video<br>
		<input type="hidden" value="<?=$filename?>" id="video" name="video"/>
		<input type="file" id="video_uploadify" name="Filedata" /><br/>
		<div id="video_image_container">
			<a id="flv_player" href="<?=base_url()?>content_assets/videos/<?=$filename?>" rel="shadowbox;width=600;height=450"><img class="main_image" src="<?=base_url()?>user_assets/prof_images/playvid.gif" alt="image" width="320" height="167" /></a>
		</div>
