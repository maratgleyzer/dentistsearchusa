<script type="text/javascript">
	...
	$(function(){
		$('input#btn_save').click(function(){
			process_form('input#btn_save','SAVE','div#dropdown_form_messages',true,'form#dropdown_form','_admin_console/home/save_dropdown_choice',false,'save_success');
		});
	})
</script>
<div>
	...
	<form id="dropdown_form">
		Dropdown Value<br/>	
		<input type="text" class="medium_input_text" name="value" /><br/><br/><br/><br/>
