<script type="text/javascript">	
	...
	$(function(){
		$('input#btn_save').click(function(){
			process_form('input#btn_save','SAVE','div#cmsuser_form_messages',true,'form#cmsuser_form','_admin_console/home/save_cms_user',false,'save_success');
		});
	})
</script>
<div>
	...
	<form id="cmsuser_form" class="admin_forms">
		...
		Name<br/>	
		<input type="text" class="medium_input_text" name="name" /><br/>
		Password<br/>	
