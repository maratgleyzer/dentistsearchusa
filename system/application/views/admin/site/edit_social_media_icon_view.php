<script type="text/javascript">
	...
	$(function(){
		$('input#btn_save').click(function(){
			process_form('input#btn_save','SAVE','div#icon_form_messages',true,'form#icon_form','_admin_console/home/save_icon/<?=$id?>',false,'save_success');
		});
...
<div>
	...
	<form id="icon_form">
		...
		<input type="hidden" id="prev_image" value="<?=$icon?>" name="image"/>
		<img id="icon_image" class="main_image" src="<?=base_url();?>assets/images/social_media_icons/<?=$icon?>" alt="image" width="20" height="20" /> <input type="file" id="image_uploadify" name="Filedata" />
		<div id="image_fileQueue" style="width: 320px;"></div>
		<br/>
		Link<br/>	
		<input type="text" class="wide_input_text" name="link" value="<?=$link?>" /><br/><br/>
		Tooltip<br/>	
		<input type="text" class="wide_input_text" name="tooltip" value="<?=$tooltip?>" /><br/><br/>
