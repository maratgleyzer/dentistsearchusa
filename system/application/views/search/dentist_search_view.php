						...
						if(data){	
							...
							if(data.success){
								...
								if(data.markers){
									...
									var centerLatlng = new google.maps.LatLng(data.markers[0].position[0],data.markers[0].position[1]);
								}else{
								...
								$('#search_result_title').text(data.search_result_title);
								$('#search_result_text').text(data.search_result_text);
			...
			<div class="two-columns">
				<div class="google-map">
					...
					<div id="map_fixed_container">
						...
						<h3 id="search_result_title" ><?=$search_result_title?></h3>
						<p id="search_result_text"><?=$search_result_text?></p>
					</div>
				</div><!-- /google-map end -->
				<div id="content">
					<div class="heading">
					...
					<div class="offices-list-wrapp">
								...
								?>
									<li>
										...
										<div class="featured_flag">&nbsp;</div>
											...
											?>
											<a href="/user_assets/prof_images/<?=$dir?>/<?=$dentist['user_id']?>/<?=$prof_pic?>" rel="shadowbox;width=600;height=450"><img src="/user_assets/prof_images/playvid_small.gif" alt="image" width="85" height="85" /></a>
											<?php } else { ?>
											<a href="/<?=prep_seo_url($dentist['city'])?>-<?=prep_seo_url($dentist['state'])?>-dentists/<?=prep_seo_url($dentist['first_name'])?>-<?=prep_seo_url($dentist['last_name'])?>-<?=$dentist['id']?>"><img src="/user_assets/prof_images/<?=$dir?>/<?=$dentist['user_id']?>/thumb.jpg" alt="image" /></a>
											<?php } } else{ ?>
											<a href="/<?=prep_seo_url($dentist['city'])?>-<?=prep_seo_url($dentist['state'])?>-dentists/<?=prep_seo_url($dentist['first_name'])?>-<?=prep_seo_url($dentist['last_name'])?>-<?=$dentist['id']?>"><img src="/assets/themes/default/images/no_photo_small.png" alt="image" width="85" height="85" /></a>
											<?php } ?>
										</div><!-- /photo end -->
						...
						<?php }else{ ?>
								<div id='no_results'>No Results Found for <label><?=$search?></label></div>
						<?php } ?>
