										...
										<div class="featured_flag">&nbsp;</div>
											<?php
												...
												if($prof_pic){
													...
													if($picvid[1]=="flv"){
											?>
													<a href="/user_assets/prof_images/<?=$prof_pic?>" rel="shadowbox;width=600;height=450">
														<img src="/user_assets/prof_images/playvid_small.gif" alt="image" width="85" height="85" />
													</a>
											<?php	}else{ ?>
												<img src="/assets/phpthumb/resize.php?src=/user_assets/prof_images/<?=$prof_pic?>&width=85&height=85" alt="image" />
											<?php 
													} 
												}else{
											?>
												<img src="/assets/themes/default/images/no_photo_small.png" alt="image" width="85" height="85" />
											<?php } ?>
										</div><!-- /photo end -->
